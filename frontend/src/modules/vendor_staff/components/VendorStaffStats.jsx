...
const VendorStaffStats = ({ stats }) => {
    const statsData = [
        { label: 'Total Vendor Staff', value: stats?.total || '0', icon: Users, color: '#4f46e5', bg: '#eef2ff' },
        { label: 'Active Now', value: stats?.active || '0', icon: UserCheck, color: '#10b981', bg: '#ecfdf5' },
        { label: 'Inactive Staff', value: stats?.inactive || '0', icon: UserPlus, color: '#f59e0b', bg: '#fffbeb' },
...
export default VendorStaffStats;
