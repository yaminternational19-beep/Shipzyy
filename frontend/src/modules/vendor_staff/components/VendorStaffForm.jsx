...
const VendorStaffForm = ({ user, onClose, onSave }) => {
    ...
    const [formData, setFormData] = useState(() => {
        if (user) {
            ...
            role = matchedRole ? matchedRole.name : (menuItems.find(m => m.name === 'Vendor Staff')?.name || menuItems[0]?.name);
        ...
        return {
            ...
            password: '',
            status: 'Active',
            role: menuItems.find(m => m.name === 'Vendor Staff')?.name || menuItems[0]?.name,
            profilePhoto: '',
            profilePhotoKey: '',
            photoFile: null
        }
        ...
        <div className="modal-overlay">
            <div className="modal-content">
                <div className="modal-header">
                    <h3>{user ? 'Edit Vendor Staff Details' : 'Add New Vendor Staff'}</h3>
                ...
                <div className="modal-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ display: 'flex', gap: '12px', marginTop: '32px' }}>
                            ...
                            <button type="submit" className="action-btn primary" style={{ flex: 2 }}>{user ? 'Update Details' : 'Save Vendor Staff'}</button>
                        </div>
                    </form>
                </div>
            </div>
