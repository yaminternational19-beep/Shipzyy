...
export const menuItems = [
    ...
    { name: "Vendor Products", key: "VENDOR_PRODUCTS", icon: Package, path: "/vendor-products", group: "PRODUCT MANAGEMENT", description: "Manage vendor-specific products" },
    { name: "Vendor Orders", key: "VENDOR_ORDERS", icon: ShoppingBag, path: "/vendor-orders", group: "PRODUCT MANAGEMENT", description: "Manage vendor orders" },
    { name: "Reports", key: "REPORTS", icon: BarChart3, path: "/reports", group: "PRODUCT MANAGEMENT", description: "View system reports" },
