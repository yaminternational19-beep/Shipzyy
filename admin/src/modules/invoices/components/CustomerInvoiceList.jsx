...
const CustomerInvoiceList = ({
    ...
    selectedIds, setSelectedIds, onSelectAll, onExport, onView, onViewHistory, isModal
}) => {
                                ...
                                <tr key={invoice.id} className={selectedIds.includes(invoice.id) ? 'selected' : ''}>
                                    ...
                                    <td className="inv-td-center">
                                        <div className="inv-avatar">
                                            <img src={invoice.customerAvatar} alt={`CUST-${invoice.customerId}`} />
                                        </div>
                                    </td>
                                    ...
                                    <td className="inv-td">
                                        <span className="inv-badge-purple">{invoice.customerId}</span>
                                    </td>
                                    ...
                                    <td className="inv-td-center">
                                        <span className={`inv-status-badge ${invoice.status.toLowerCase()}`}>
                                            {invoice.status === 'Pending' ? 'Payment Not Done' : invoice.status}
                                        </span>
                                    </td>
                                    ...
                                    <td className="inv-td-right">
                                        <div className="inv-actions">
                                            {!isModal && (
                                                <button 
                                                    onClick={() => onViewHistory(invoice.customerId)}
