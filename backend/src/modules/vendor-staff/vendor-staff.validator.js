...
const createVendorStaffSchema = Joi.object({
...
const updateVendorStaffSchema = Joi.object({
...
export { createVendorStaffSchema, updateVendorStaffSchema, updatePermissionsSchema };
