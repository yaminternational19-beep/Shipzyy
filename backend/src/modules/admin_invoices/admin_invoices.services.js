...
export const listVendorInvoices = async (queryParams = {}) => {
    ...
    const [rows] = await db.query(`
        SELECT 
            ...
            COALESCE(NULLIF(v.profile_photo, ''), 'https://shipzzy-files-094794931012-ap-south-1-an.s3.ap-south-1.amazonaws.com/placeholders/user-avatar.png') AS vendor_avatar,
...
export const listCustomerInvoices = async (queryParams = {}) => {
    ...
    const [rows] = await db.query(`
        SELECT 
            ...
            COALESCE(NULLIF(c.profile_image, ''), 'https://shipzzy-files-094794931012-ap-south-1-an.s3.ap-south-1.amazonaws.com/placeholders/user-avatar.png') AS customer_avatar,
